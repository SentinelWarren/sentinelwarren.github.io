...
On a side note, I had a scheme porting joke, brackets joke and a maybe chicken chibi chez racket and whatnot joke, and the monad too if you know what i mean! but unfortunately, i stupidly close my emacs without saving(such a noob!), so every sketch i managed to scratch down went to waste!
Anyways the point is, this is gonna be your simple (yet full of bugs) solution to the tiresome process of having to choose among the  available scheme interpreter implementations from various institutes from the big-market scene. Beware, currently there a bunch of em...
